  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const localId = typeof window !== "undefined" ? localStorage.getItem("activeProductId") : null;
        const targetId = idParam || localId;
        const found = targetId ? all.find((p) => p.id === targetId) : null;
